...
from .constants import (
    ...
    CUSTOM_NODES_DIR, SAUSMSG, logger, SAUS_APPS_PATH,
    WEBROOT, CORE_PATH, SAUS_BROWSER_PATH,
    SAFE_FOLDER_NAME_REGEX, ALLOWED_EXTENSIONS, CUSTOM_THEMES_DIR, APPS_CONFIG_FILE, MODELS_DIRECTORY,
...
# This function handles the request for the list of apps
...
TEMP_UPLOAD_DIR = "/tmp/app_uploads" # Use a dedicated temp path
...
async def get_architectures_handler(request: web.Request) -> web.Response:
    """
    Handles the GET request for the /saus/api/architectures endpoint.
...
async def get_model_data_handler(request: web.Request) -> web.Response:
    """
    Handles the GET request for the get_model_data_handler/saus/api/data-model-data/ endpoint.
